...
const History = ({ image, description }: Props) => {
  return (
    <section className='p-4 laptop:px-24 laptop:py-28 desktop:py-28 tablet:py-28 phone:py-7'>
      <div className='w-full flex flex-col justify-around items-center'>
        ...
        <div className='grid grid-cols-1 laptop:grid-cols-2 gap-[135px] justify-center items-center mt-10'>
          <p className='text-base' dangerouslySetInnerHTML={{__html: description}}></p>
